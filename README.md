...
1. [Modulo A](#1ModuloA) → tirante (Temperatura e Umidità, Aria, Vibrazioni) - Arduino Nano 33 BLE Sense Rev2
2. [Modulo B](#2ModuloB) → galleria (Batterie, Temperatura e Umidità, Aria, Allagamento) - Arduino Pro Mini
3. [Modulo C](#3ModuloC) → polveriera (Batterie, Temperatura e Umidità) - Arduino Pro Mini
