...
## I moduli
- [A](#ModuloA) → tirante (Temperatura e Umidità, Aria, Vibrazioni) - Arduino Nano 33 BLE Sense Rev2
- [B](#ModuloB) → galleria (Batterie, Temperatura e Umidità, Aria, Allagamento) - Arduino Pro Mini
- [C](#ModuloC) → polveriera (Batterie, Temperatura e Umidità) - Arduino Pro Mini
